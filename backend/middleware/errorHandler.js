export function errorHandler(error,req,res,next) {
  ...
  if (status>=500) console.error('[api]',error.code || error.name,error.message,{dbHost:process.env.DB_HOST || 'unset',dbPort:process.env.DB_PORT || '3306',dbName:process.env.DB_NAME || 'portfolio_db',dbSslMode:process.env.DB_SSL_MODE || 'disabled'});
